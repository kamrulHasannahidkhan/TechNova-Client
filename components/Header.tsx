      ...
      <div className="max-w-6xl mx-auto flex justify-between items-center px-4 sm:px-6 py-4">
        ...
        <div className="flex items-center gap-4 text-sm font-medium">
          <div className="hidden sm:flex items-center gap-4">
            {user ? (
              <Link href="/account" className="text-ink hover:text-signal transition">
                {user.name.split(" ")[0]}
              </Link>
            ) : (
              <>
                <Link href="/signin" className="text-steel hover:text-signal transition">
                  Sign In
                </Link>
                <Link
                  href="/signup"
          ...
          <Link href="/cart" className="relative text-ink hover:text-signal transition">
            Cart
            {count > 0 && (
