        ...
        <div className="flex items-center gap-4 text-sm font-medium">
          {session?.user ? (
            <>
              ...
              <button onClick={() => signOut({ callbackUrl: "/" })} className="hover:text-[--signal] transition">
                Sign out
              </button>
            </>
          ) : (
            <>
              ...
              <Link href="/signup" className="bg-[--ink] text-white px-3.5 py-1.5 rounded-lg hover:bg-[--signal] transition">
                Sign Up
              </Link>
            </>
          )}
