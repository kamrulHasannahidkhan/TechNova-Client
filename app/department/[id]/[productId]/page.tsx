    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-12">
      <nav aria-label="Breadcrumb" className="mb-6">
        <ol className="flex items-center gap-2 text-xs text-[--steel]">
          ...
          <li>/</li>
          <li><Link href={`/department/${id}`} className="hover:text-[--signal]">Department</Link></li>
          <li>/</li>
          <li className="text-[--ink] font-medium truncate max-w-[200px] sm:max-w-xs">{product.name}</li>
        </ol>
      </nav>

      <div className="bg-[--surface-subtle] border border-[--line] rounded-3xl p-6 md:p-10 grid md:grid-cols-12 gap-8 md:gap-12 items-start">
        <div className="md:col-span-6 space-y-4">
          <div className="relative w-full aspect-square bg-slate-50 rounded-2xl border border-[--line] overflow-hidden flex items-center justify-center p-6">
            {product.images?.[0] ? (
              <Image
        ...
        <div className="md:col-span-6 flex flex-col justify-between space-y-6">
          ...
          <div className="space-y-3 pt-4 border-t border-[--line]">
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="flex items-center gap-2.5 p-3 rounded-xl bg-slate-50 border border-[--line]">
