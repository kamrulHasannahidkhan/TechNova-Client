...
export default async function ExclusivePage() {
  const products = await getProductsByTag("exclusive");

  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      <h1 className="font-display text-3xl font-bold tracking-tight mb-8">Exclusive</h1>
      {products.length === 0 ? (
        <p className="text-[--steel]">No exclusive products yet.</p>
      ) : (
